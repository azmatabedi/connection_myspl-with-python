 ...
 "cells": [
  ...
  },
  {
   ...
   "outputs": [
    {
     "data": {
      "text/html": [
       ...
       "      <th>12213</th>\n",
       "      <td>12215</td>\n",
       "      <td>2009-12-04T09:00:00+00:00</td>\n",
       "      <td>2164.25</td>\n",
       "      <td>323.0</td>\n",
       "      <td>1200.5</td>\n",
       "      <td>375.0</td>\n",
       ...
       "      <td>NaN</td>\n",
       "      <td>NaN</td>\n",
       "      <td>Newfoundland Road Police Station</td>\n",
       "      <td>51.4606738207,-2.58225341824</td>\n",
      ...
      "text/plain": [
       "       Unnamed: 0                  Date Time      NOx    NO2      NO  SiteID  \\\n",
       "12213       12215  2009-12-04T09:00:00+00:00  2164.25  323.0  1200.5   375.0   \n",
       "\n",
       "       PM10  NVPM10  VPM10  NVPM2.5  ...  SO2  Temperature  RH  Air Pressure  \\\n",
       "12213   NaN     NaN    NaN      NaN  ...  NaN          NaN NaN           NaN   \n",
       "\n",
       "                               Location                  geo_point_2d  \\\n",
       "12213  Newfoundland Road Police Station  51.4606738207,-2.58225341824   \n",
       "\n",
       "                       DateStart                    DateEnd Current  \\\n",
       "12213  2005-01-01T00:00:00+00:00  2015-12-31T00:00:00+00:00   False   \n",
       "\n",
       "              Instrument Type  \n",
       "12213  Continuous (Reference)  \n",
       "\n",
       "[1 rows x 24 columns]"
      ]
     },
   ...
   "source": [
    ...
    "#print(df['NO'])\n",
    "max_no=max(df['NO'])\n",
    "df = df.loc[(df['Date Time'] >= '2019-01-01') | (df['NO']==max_no)]\n",
    "#df = df.loc[(df['Date Time'] >= '2019'|df['NO']==max_no) ]#&  (df['Date Time']<='2019-12-31')]\n",
    "df\n",
    "#df.query('Date Time' >= '2019-01-01')"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    "#df = df.loc[(df['Date Time'] >= '2019-01-01') | (df['NO']==max_no)]\n",
    "#sql_a=\"SELECT Date Time,SiteID,NO from pollution_db WHERE NO==max_no or Date Time=>'2019-01-01\""
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [],
   "source": [
    "sql_b=\"select AVG(PM2.5),AVG(VPM2.5) from pollution_db group by SiteID\""
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    "df = df.loc[(df['Date Time'] >= '2010-01-01') | (df['Date Time']<='2019-12-31')]\n",
    "df"
   ]
  },
  {
   ...
   "outputs": [],
   "source": [
    "sql_c=\"select * from pollution_db where Date Time >='2010-01-01' |Date Time <='2019-12-31'\""
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [],
   "source": [
    "with open ('query-c.sql','w') as file:\n",
    "    file.write(sql_c)\n",
    "file.close()    "
   ]
  }
